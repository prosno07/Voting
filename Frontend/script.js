...
const timerMessage = document.querySelector('#timerMessage'); // Added '#' before 'timerMessage'
...
// Configuring Ethers
const contractAddress = '0x4A9E4Ee86B40d76f1B0f2d61AfB03057d1064822';
const contractABI = [
    {
      "inputs": [],
...
let contract;
let signer;
const provider = new ethers.providers.Web3Provider(window.ethereum, 11155111); // Corrected 'web3Provider' to 'Web3Provider'
...
const refreshPage = function () {
    setInterval(async () => {
        ...
        if (time > 0) {
            ...
            timerMessage.textContent = "Either there's no election yet or the election already ended"; // Corrected 'ot' to 'or'
...
const startElection = async function () {
  ...
  candidates.value = "";
  electionDuration.value = ""; // Corrected 'electionDuration = "";' to 'electionDuration.value = "";'
...
const getAccount = async function() {
  if (window.ethereum) {
    try {
      ...
      connectWalletBtn.textContent = "You are currently connected...";
